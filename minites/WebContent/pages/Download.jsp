...
<!-- 민지부탁해 -->
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <div>
            ...
            <!--     <div class="col-sm-10">
             ...
             <!--   <tr>
               <td>
                <div class="goalText well_invite well-lg" width="800px">
                	<input type="text" class="form-control" name="to"  placeholder="초대하실 멤버의 이메일을 입력해주세요!"/>
               	</div>
            	</td>
            	</tr> -->
                
                <tr><td colspan="2" style="text-align:right;"><input type="submit" class="btn btn-theme03" value="다운로드" onclick="goDownload()"/></td></tr>
   ...
   <!-- 캘린더 CSS 추가 -->
	...
	<script type="text/javascript">
		function goDownload(){
			location.href="../Meeting/fileDownLoad.action?fileLocation=${file }";
		}
	</script>
