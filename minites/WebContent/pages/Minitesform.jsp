...
<head>
	...
	/* 	#create{
		...
		#add{	padding:10px;
	 	...
	 	#titleDiv{color:#585858;}
		.agenda{padding:10px;margin:10px;border-radius:10px;}
...
<%--       <aside>
 ...
 --%>      <!--sidebar end-->
      ...
      <!-- 본문@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
      <!--main content start-->
      <section id="main-content" style="margin-left:100px;">
...
<div id="add">
 ...
 <div id="goal" class="goalText"><textarea class="" id="goalText"  placeholder="미팅 목표를 입력하세요" style="padding:6px;border-style:none;width:95%;"></textarea></div>
 ...
 */
	      ...
	      //Todo 등록
			...
			for (var i = 0; i < collaboratorCount; i++) {
	  		...
	  		if(app.todoList[app.todo_primaryKey].timeRemaining > 0){
	  			...
	  			+"<table class='table table-hover'><tr><td><img src= '"+photo+"' style='border-radius: 50%;'></td><td style='width:15%'><span class='glyphicon glyphicon-ok' style='color:green'></span></td><td style='width:20%'>"+app.todoList[app.todo_primaryKey].who+"</td><td style='width:50%'>"+app.todoList[app.todo_primaryKey].what+"&emsp;&emsp;<button type='button' class='btn btn-success btn-sm d-day'>D-"+app.todoList[app.todo_primaryKey].timeRemaining+"</button>"
	  			...
	  			var st= "<div id='todoDiv"+app.todoList[app.todo_primaryKey].no+"' class='todoDiv table-responsive'>"
	  			+"<table class='table table-hover'><tr><td><img src= '"+photo+"' style='border-radius: 50%;'></td><td style='width:15%'><span class='glyphicon glyphicon-ok' style='color:green'></span></td><td style='width:20%'>"+app.todoList[app.todo_primaryKey].who+"</td><td style='width:50%'>"+app.todoList[app.todo_primaryKey].what+"&emsp;&emsp;<button type='button' class='btn btn-danger btn-sm d-day'>D-DAY</button>"
	  			+"</td><td style='width:15%'><button type='button' class='btn btn-danger btn-xs' onclick = 'deleteTodo("+app.todo_primaryKey+")'  id='todoDelete"+app.todo_primaryKey+"'> <span class='glyphicon glyphicon-remove' aria-hidden='true'></span></button>"
	  			+"</td></tr></table></div>";
	  		}else{
	  			var st= "<div id='todoDiv"+app.todoList[app.todo_primaryKey].no+"' class='todoDiv table-responsive'> "
	  			+"<table class='table table-hover'><tr><td><img src= '"+photo+"' style='border-radius: 50%;'></td><td style='width:15%'><span class='glyphicon glyphicon-ok' style='color:green'></span></td><td style='width:20%'>"+app.todoList[app.todo_primaryKey].who+"</td><td style='width:50%'>"+app.todoList[app.todo_primaryKey].what+"&emsp;&emsp;<button type='button' class='btn btn-warning btn-sm d-day'>D+"+Math.abs(app.todoList[app.todo_primaryKey].timeRemaining)+"</button>"
	  			+"</td><td style='width:15%'><button type='button' class='btn btn-danger btn-xs' onclick = 'deleteTodo("+app.todo_primaryKey+")'  id='todoDelete"+app.todo_primaryKey+"'> <span class='glyphicon glyphicon-remove' aria-hidden='true'></span></button>"
	  			+"</td></tr></table></div>";
	  		}
	  		$('#'+loca).append(st);
		...
		function addComment(){
			...
			for (var i = 0; i < collaboratorCount; i++) {
  			...
  			+"<table class='table table-hover'><tr><td><img src= '"+photo+"' style='border-radius: 50%;'></td><td style='width:15%'><span class='glyphicon glyphicon-comment' style='color:#CC0000'></span></td><td style='width:20%'>"+app.commentList[app.comment_primaryKey].cwho+"</td><td style='width:50%'>"+app.commentList[app.comment_primaryKey].cwhat+"</td><td style='width:15%'>"
	...
	function onFileLoaded(doc){
        ...
        function displayCollaboratorEvent(evt){
        	...
        	'<img src='+user.photoUrl+'style="border-radius: 50%;">'+
		...
		var wholeString = "<h1><b>"+setedTitleValue+"</b></h1><h3>"+setedDateValue+"<h3>";
	...
	function onTodoListAdded(evt){
		...
		if(!isLocal){
			...
			if(lastTodo.timeRemaining > 0){
	  			...
	  			+"<table class='table table-hover'><tr><td><img src='"+photo+"' style='border-radius: 50%;'></td><td style='width:15%'><span class='glyphicon glyphicon-ok' style='color:green'></span></td><td style='width:20%'>"+lastTodo.who+"</td><td style='width:50%'>"+lastTodo.what+"&emsp;&emsp;<button type='button' class='btn btn-success btn-sm d-day'>D-"+lastTodo.timeRemaining+"</button>"
	  			...
	  			var st= "<div id='todoDiv"+lastTodo.no+"' class='todoDiv table-responsive'>"
	  			+"<table class='table table-hover'><tr><td><img src='"+photo+"' style='border-radius: 50%;'></td><td style='width:15%'><span class='glyphicon glyphicon-ok' style='color:green'></span></td><td style='width:20%'>"+lastTodo.who+"</td><td style='width:50%'>"+lastTodo.what+"&emsp;&emsp;<button type='button' class='btn btn-danger btn-sm d-day'>D-DAY</button>"
	  			...
	  			var st= "<div id='todoDiv"+lastTodo.no+"' class='todoDiv table-responsive'> "
	  			+"<table class='table table-hover'><tr><td><img src='"+photo+"' style='border-radius: 50%;'></td><td style='width:15%'><span class='glyphicon glyphicon-ok' style='color:green'></span></td><td style='width:20%'>"+lastTodo.who+"</td><td style='width:50%'>"+lastTodo.what+"&emsp;&emsp;<button type='button' class='btn btn-warning btn-sm d-day'>D+"+Math.abs(lastTodo.timeRemaining)+"</button>"
	  			+"</td><td style='width:15%'><button type='button' class='btn btn-danger btn-xs' onclick = 'deleteTodo("+lastTodo.no+")'  id='todoDelete"+lastTodo.no+"'> <span class='glyphicon glyphicon-remove' aria-hidden='true'></span></button>"
	  			+"</td></tr></table></div>";
	  		}
	...
	function onCommentListAdded(evt){
		...
		if(!isLocal){
			...
			var st= "<div id='commentDiv"+lastComment.cno+"' class='table-responsive'> "
  			+"<table class='table table-hover'><tr><td><img src='"+photo+"' style='border-radius: 50%;'></td><td style='width:15%'><span class='glyphicon glyphicon-comment' style='color:#CC0000'></span></td><td style='width:20%'>"+lastComment.cwho+"</td><td style='width:50%'>"+lastComment.cwhat+"</td><td style='width:15%'>"
...
<div id="todoModal" class="modal fade" role="dialog" style="margin-left:10%;margin-top:15%;">
 	
    <div class="modal-dialog">  
    
     <div class="modal-content" style="width:80%;height:auto;padding:20px;">      
    <table style="text-align: left; width:100%;padding:20px;">
    <tr>
    	<td>
     <!-- profile pictures -->
     ...
     <!-- todo textarea --> 
      <label for="texts">Todo</label>
      	...
      	<td>
       <textarea class="form-control" name="todo_texts" id="todo_texts" style="padding-bottom:40px;"></textarea>
     	</td>
    </tr>
    <tr style="text-align: center;">
      <td colspan="2">
      	<input type="button" class="insert_todo btn btn-default" data-dismiss="modal" onclick="$('#todo_texts').text('');" value="추가">
...
<div id="commentModal" class="modal fade" role="dialog" style="margin-left:5%;margin-top:15%;">
 	
    <div class="modal-dialog"  style="width:500px;height:auto;padding:20px;"> 
      <div class="modal-content" style="text-align: left; width:100%;padding:20px;">      
    <table style="text-align: left; width:100%;padding:20px;">
    <tr>
    	<td>
     <!-- profile pictures -->
    ...
    <!--   <input type="text" name="comment_texts" id="comment_texts" class="form-control">
     -->  <textarea class="form-control" name="comment_texts" id="comment_texts" ></textarea>
     	</td>
    </tr>
    <tr style="text-align: center;">
      <td colspan="2">
                      ...
                      <div class="desc" style="text-align:center;" id="collaborators">
                       ...
                       <!-- USERS ONLINE SECTION -->
    					...
    					<div class="form-group">
     						 <label for="usr"> </label>
      						<input type="text" class="form-control" id="addperson" placeholder="이름 , 이메일 검색">
   						 </div>
   						</form>
...
<script>
 ...
 $("#addperson").change(function(){
  ...
  function output(msg) { //참석자 리스트 가져오기
	...
	str+='<div class="desc">';
	str+='<div class="thumb">';
	str+='<img class="img-circle" src="https://cdn4.iconfinder.com/data/icons/48-bubbles/48/31.ID-Horizontal-128.png" width="35px" height="35px" align="">'; 
	str+='</div><div class="details">';
	str+='<p><b>&nbsp;&nbsp;&nbsp;'+item.name+'</b><br>';	
	str+='&nbsp;&nbsp;&nbsp;'+item.participants_id+'</p></div></div>';          		
	...
	str="<select id='slavers' class='form-control'>";
	...
	str="<select id='slavers2' class='form-control'>";
